...
A tCrm belső üzemeltetői rendszer. Ez az útmutató lépésről lépésre segít a napi munkában.
...
1. Ha ez az első indítás és még nincs rendszergazda, a rendszer a **Beállítás varázslóra** (`/setup`) irányít — itt hozod létre az első adminisztrátori fiókot.
...
| Médiatár | Központi kép- és fájltár |
| Raktárak | Raktár törzsadatok és raktári munkatársak |
| Arculat | Alkalmazásnév, logó, favicon, bejelentkezési oldal megjelenése |
