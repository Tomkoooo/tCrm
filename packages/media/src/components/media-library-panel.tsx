...
import { Button, Checkbox, FileUploadButton, Input, Label } from '@crm/ui';
...
import { mediaPreviewPath, type MediaListItem, type SelectedMedia } from '../paths';
import { ImageCropper } from './image-cropper';
import { isPdfMedia, MediaThumbnail } from './media-thumbnail';

/** `name · sku`, or just `sku` when no display name is available. */
function formatProductSkuLine(name: string | undefined, sku: string): string {
