...
type AccordionConfig = {
  sections: Record<ProductEditSectionId, boolean>;
  setOpen: (id: ProductEditSectionId, open: boolean) => void;
};
...
function FormSection({
  ...
  const contentClassName = `grid gap-4 md:grid-cols-2 ${compact ? 'px-0' : ''}`;
  ...
  if (accordion) {
    return (
      <ProductEditSection
        ...
        open={accordion.sections[sectionId]}
        onOpenChange={(open) => accordion.setOpen(sectionId, open)}
        compact={compact}
      >
  ...
  return (
    <>
      <FormSection
        ...
        title="Azonosítók"
        description={accordion ? 'Excel: product_id, product_id_SM, crm_*' : undefined}
        accordion={accordion}
        compact={compact}
      >
        <Field
      ...
      <FormSection sectionId="pricing" title="Árak" accordion={accordion} compact={compact}>
        <Field
      ...
      <FormSection sectionId="misc" title="Egyéb" accordion={accordion} compact={compact}>
        <Field
          id="freightlevel"
          label="Freight level"
          name="freightlevel"
