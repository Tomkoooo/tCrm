...
import { connectDB, Vehicle } from '@crm/db-core';
import { LOGISTICS_VEHICLES_READ_PERMISSION_KEYS } from '@crm/logistics/permissions';
...
export default async function VehicleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [canWrite, currentUser, incidents, allWarnings] = await Promise.all([
