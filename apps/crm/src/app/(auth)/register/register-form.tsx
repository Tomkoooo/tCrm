  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader>
        ...
        <CardDescription>tCrm fiók és opcionális dolgozói profil</CardDescription>
      </CardHeader>
      <CardContent>
        <form action={formAction} className="flex flex-col gap-6">
          ...
          {hasCompanies ? (
            ...
            <p className="text-muted-foreground text-sm">
              Dolgozói profil: a HR-nek előbb létre kell hoznia egy céget, vagy az admin hozza létre
              a fiókját.
            </p>
          )}
